...
public class T1_YahooScreenshot extends Reusable_Annotations {
    @Test(priority=1)
    public void tc001_verifySignedInOptionIsChecked(){
        //navigate to yahoo.com
        driver.navigate().to("https://www.yahoo.com");
        //next we need to click on sign in button
        Reusable_Actions_Loggers.clickAction(driver, "//*[@class='_yb_1933easddasadsdsasadadsads']", logger, "Sign in button");
